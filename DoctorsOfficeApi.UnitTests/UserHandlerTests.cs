...
public class UserHandlerTests
{
    ...
    {
        // arrange
        A.CallTo(() => _fakeUserService.GetUserByIdAsync(A<string>.Ignored)).Throws(new NotFoundException(""));
    ...
    public async void GetUserByIdHandler_IdExists_ReturnsUser()
    {
        ...
        A.CallTo(() => _fakeUserService.GetUserByIdAsync(A<string>.Ignored)).Returns(appUser);
    ...
    public async Task GetUserRefreshTokensHandler_UserIdExists_ReturnsRefreshTokens()
    {
        ...
        var query = new GetRefreshTokensByUserIdQuery(Guid.NewGuid().ToString());
