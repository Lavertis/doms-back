...
public class CreateTimetableValidator : AbstractValidator<IEnumerable<CreateTimetableRequest>>
{
    public CreateTimetableValidator(ITimetableRepository timetableRepository, IHttpContextAccessor httpContextAccessor)
    {
        ...
        RuleFor(x => x)
            .NotEmpty()
            .WithMessage("CreateTimetableRequestList cannot be empty");
